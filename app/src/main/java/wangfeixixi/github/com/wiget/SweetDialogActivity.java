...
public class SweetDialogActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sweet_dialog_activity);
                ...
                new SweetAlertDialog(this, SweetAlertDialog.ERROR_TYPE)
                        ...
                        .setCancelClickListener(new SweetAlertDialog.OnSweetClickListener() {
                            ...
                            public void onClick(SweetAlertDialog sweetAlertDialog) {
                                Toast.makeText(SweetDialogActivity.this, "嘎嘎嘎", Toast.LENGTH_LONG).show();
                            }
                        }).setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                    @Override
                    public void onClick(SweetAlertDialog sweetAlertDialog) {

                        Toast.makeText(SweetDialogActivity.this, "hhhhhhh", Toast.LENGTH_LONG).show();
                    }
                })
                        .show();
                break;
